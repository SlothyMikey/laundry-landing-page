...
export default function Hero() {
  return (
    <>
      <section id="home" className='flex items-center justify-center w-full h-screen max-h-[768px]'>
        <div className='flex flex-col md:flex-row justify-evenly w-full max-w-screen-xl mx-auto px-4 md:px-8'>
        {/* Left Side */}
        ...
        <div className="hidden md:flex flex-div items-center sm:w-1/2 justify-center">
          <img
            ...
            alt="Laundry Service"
            className="w-2/3 max-w-full h-auto rounded-lg shadow-lg"
          />
        </div>
        </div>
      </section>
